...
/**
 * The frame of screen1, the user can choose the seats in this frame
 * @author Fan
 *
 */
public class screen1frame extends JFrame implements ActionListener{
	...
	public screen1frame(String moviename,String screen, String[] tickettime, String choosetime,String tickettype, int ticketnumber, String seat,String stunum) {
		...
		/*This part of code will find out the used seats in data.txt,and unable the used seats*/
		try{
			...
			while((line=reader.readLine())!=null){
				...
				if(list[1].equals("screen1")&&list[2].equals(choosetime)&&list[0].equals(moviename)){
